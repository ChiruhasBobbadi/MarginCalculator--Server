...
const path = require('path');
 ...
 module.exports.commodity =function (){
     try{
       ...
       console.log("exception in astha commodity" + new Date().getDate());
   }
...
module.exports.equity=function(){
    try{
        ...
        console.log("exception in astha equity" + new Date().getDate());
    }
...
module.exports.futures=function() {
    ...
    try{
        ...
        console.log("exception in astha futures " + new Date().getDate());
    }
